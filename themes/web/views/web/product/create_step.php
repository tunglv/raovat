    ...
    <div class="da-panel">
        <div class="da-panel-header">
            <span class="da-panel-title">
                Bước <?php echo ($model->isNewRecord ? $step : $model->step )?>
            </span>
        </div>
        ...
        <div id="da-ex-tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            ...
            <div style="padding-bottom: 20px;">
                ...
                <h4 class="widgettitle">Nội dung bước <?php echo ($model->isNewRecord ? $step : $model->step )?></h4>
                ...
                <script>
                    $(function(){
                        $("#a_url").click(function(){
                            ...
                            $("#img_url").show();
                            $('#img_file').hide();
                            $('#StepCreateContent_upload_method').val('url');    
                        });
                        $("#a_file").click(function(){
                            ...
                            $("#img_url").hide();
                            $('#img_file').show();
                            $('#StepCreateContent_upload_method').val('file');    
                        });
                        ...
                        $("#StepCreateContent_image_url").bind('change keyup blur', function(evt){
                            var method = $('#StepCreateContent_upload_method').val();
                ...
                <div class="par control-group">
                    ...
                    <div class="controls">
                        <?php if($this->action->id == 'updateStep'):?>
                            <img id="img_file" style="display: none; height: 60px; width: auto; margin-left: 220px;" /> 
                            <img id="img_url" style="height: 60px; width: auto; margin-left: 220px;" src="<?php echo $model->getImageUrl();?>"/>
                            <!--<img style="height: 60px; width: auto;margin-left: 220px;" src="<?php // echo StepCreateContent::model()->getImgUrl($model->id, $model->image.'_small.jpg');?>" />-->
                            <?php else:?> 
                            <img id="img_file" style="display: none; height: 60px; width: auto; margin-left: 220px;" /> 
                ...
                <p class="stdformbutton">
                    <?php echo CHtml::submitButton($model->isNewRecord ? 'Next' : 'Save', array('class' => 'btn btn-info','name'=>'cmd')); ?>
                    <?php if($model->isNewRecord) echo CHtml::submitButton('End', array('class' => 'btn btn-info', 'name'=>'cmd')); ?>
                </p>
                <?php $this->endWidget(); ?>
            </div>
        </div>
