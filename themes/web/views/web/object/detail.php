    ...
    <div class="two-thirds column">
        ...
        <div class="recent-work gallery clearfix">
            ...
            <div role="application" style="width: 100.2%;" class="slidewrap">
                ...
                <div class="two-thirds column"> <h2 class="title">Bán máy tính siêu phẩm công nghệ<span class="line"></span></h2> </div>
                <div id="fb-root"></div>
                ...
                <div class="two-thirds column item" style="text-align:justify;font-family: tahoma, geneva, sans-serif;color: #000;">
                    <strong style="padding: 0 0 20px;display: block;line-height: 25px;">Việc Trung Quốc đang biến những bãi cạn trên quần đảo Trường Sa (của Việt Nam) thành những căn cứ quân sự (phi pháp) để độc chiếm Biển Đông khiến Mỹ không thể ngồi yên.</strong>
